...
ActiveRecord::Schema[7.1].define(version: 2024_08_09_153345) do
  ...
  create_table "gifts", force: :cascade do |t|
    ...
    t.index ["sender_id"], name: "index_gifts_on_sender_id"
  ...
  create_table "hosts", force: :cascade do |t|
    ...
    t.index ["wedding_id"], name: "index_hosts_on_wedding_id"
  end
  ...
  add_foreign_key "hosts", "weddings"
end
